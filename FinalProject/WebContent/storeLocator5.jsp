	    ...
	    <td colspan="3">
	        ...
	        <tr>
	            <td><img src="images/cropped-cropped-d2d-logo.jpg" align="left" height="150"></td>
	               ...
	               D2Decoys</font><br><font face="Times New Roman" size="4">Store Locator</font> </p>
 </td>
...
<table cellspacing="1" cellpadding="1" width="100%" border="0">
    ...
    <tr>
    	<td>
    		<h2> No matches, please try again!</h2>
		</td>    
    <tr>
    <td>
    	<h2> Ace Hardware of Watkinsville </h2>
    <h3> 2041 Hog Mountain Rd, Watkinsville, GA 30677</h3>
    </td>
    </tr>
        <tr>
            <td bgcolor="#c0cdd2" colspan="2">
            <p align="center"><img src="images/Watkinsville.jpg" width="900" height="474" alt="" /></p>
            </td>
        </tr>
        <tr>
    <td>
    <h2> Shooter's Den of Watkinsville </h2>
    <h3> 1040 Turkey Industrial Rd, Watkinsville, GA 30677</h3>
    </td>
    </tr>
        <tr>
            <td bgcolor="#c0cdd2" colspan="2">
